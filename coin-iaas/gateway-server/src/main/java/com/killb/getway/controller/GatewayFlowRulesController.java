package com.killb.getway.controller;
...
public class GatewayFlowRulesController {
     ...
     *
     * @Param: []
     * @return: com.alibaba.csp.sentinel.adapter.gateway.common.api.ApiDefinition
     * @Author: xiaozhang666
     * @Date: 2021/6/22 16:41
     */
    @GetMapping("/api")
    public ApiDefinition getApi() {
        return GatewayApiDefinitionManager.getApiDefinition("admin-service-api");
    }
}
